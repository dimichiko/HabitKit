...
const getPlanDisplayName = (plan: string) => {
  switch (plan) {
    case 'KitFull': return '🌐 Lifehub Full';
...
const AccountPage = () => {
  ...
  const [loadingPlan] = useState(false);
  const [successPlan, setSuccessPlan] = useState('');
  const [errorPlan] = useState('');
          ...
          <div className="bg-white rounded-xl shadow p-6 col-span-1 w-full flex flex-col justify-between h-full flex-1">
            ...
            {!edit && !compact ? (
              ...
              <div className="flex flex-col gap-2">
                ...
                <div><span className="font-semibold">Plan:</span> {getPlanDisplayName(user.plan)}</div>
        ...
        <div className="w-full flex flex-col items-center">
          ...
          <div className="w-full max-w-sm space-y-6">
            ...
            <div className="bg-gradient-to-r from-purple-50 to-indigo-50 p-8 rounded-2xl border border-purple-200 shadow-lg">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-3xl font-bold text-purple-600">{getPlanDisplayName(user.plan)}</p>
                </div>
              </div>
            ...
            <div className="space-y-4">
              <button className="w-full bg-purple-600 hover:bg-purple-700 transform hover:scale-105 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-200 shadow-lg hover:shadow-xl" onClick={() => {
                // Lógica para actualizar plan
                setSuccessPlan('Plan actualizado correctamente');
