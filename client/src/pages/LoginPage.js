      ...
      if (error.response) {
        ...
        switch (status) {
          case 401:
            ...
            break;
          case 423:
            setErrors({ submit: data.message || 'Cuenta temporalmente bloqueada' });
            break;
          case 400:
            if (data.requiresTwoFactor) {
              setRequiresTwoFactor(true);
              setErrors({ submit: 'Código de autenticación de dos factores requerido' });
              ...
              setErrors({ submit: data.message || 'Datos de entrada inválidos' });
            }
            break;
          default:
