      ...
      if (idea.id === id) {
        ...
        if (hasLiked) {
          ...
          return {
            ...idea,
            likes: idea.likes - 1,
            likedBy: idea.likedBy.filter(uid => uid !== user.id)
          };
        } else {
          // Agregar like
          return {
            ...
            dislikedBy: hasDisliked ? idea.dislikedBy.filter(uid => uid !== user.id) : idea.dislikedBy
          };
        }
      }
      return idea;
      ...
      if (idea.id === id) {
        ...
        if (hasDisliked) {
          ...
          return {
            ...
            dislikedBy: idea.dislikedBy.filter(uid => uid !== user.id)
          };
        } else {
          // Agregar dislike
          return {
            ...
            likedBy: hasLiked ? idea.likedBy.filter(uid => uid !== user.id) : idea.likedBy
          };
        }
      }
      return idea;
